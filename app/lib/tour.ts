...
export function startTour() {
    driver({
        ...
        steps: [
            ...
            { element: '#tour-prompt-tab-preload', popover: { title: 'Initialization Prompt Editor', description: 'A prompt that is ran at the start of the conversation to gather information about the topic, participants, or anything else.  This information that can be subsequently accessed by your mediator during the conversation.' } },
            ...
            { element: '#tour-create', popover: { title: 'Test your mediators', description: 'You can test your mediator and see how the participants will experience it during the discussion. You can either test it in a discussion between you and a friend, you can test it by discussing with an agent, or you can test it by discussing seeing how two agents discuss with each other.' } },
