...
export function startTour() {
    driver({
        ...
        steps: [
            ...
            { element: '#tour-prompt-tab-response', popover: { title: 'Response Prompt Editors', description: 'Response controls what the mediator says. Each prompt block represents a specific type of input to the mediator.' } },
            { element: '#tour-prompt-tab-should-respond', popover: { title: 'ShouldRespond Prompt Editors', description: 'Should Respond decides when the mediator replies.' } },
            { element: '#tour-prompt-tab-preload', popover: { title: 'Info Bank Prompt Editors', description: 'Information Bank builds a private information / evidence bank at the beginning of the chat.' } },
